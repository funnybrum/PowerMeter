...
TRACKERS = [
    ...
    Tracker('bat_inv.op_mode', 'inverter.battery.op_mode', {"source": "sunny_island", "src": "sma"}, False, False, False, True),
    Tracker('bat_inv.grid_status', 'inverter.battery.grid_status', {"source": "sunny_island", "src": "sma"}, False, False, False, True),
